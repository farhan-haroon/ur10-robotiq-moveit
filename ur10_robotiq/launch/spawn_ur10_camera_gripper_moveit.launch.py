...
def generate_launch_description():
    ...
    # --- share dirs ---
    uryt_share     = get_package_share_directory("ur10_robotiq")
    ...
    world_file = os.path.join(get_package_share_directory('ur10_robotiq'), 'worlds', 'clutter_18.world')
    ...
    ros2_controllers_path = os.path.join(
        ...
        "config", "ur10_controllers_gripper.yaml"
    )
    ...
    ld.add_action(ur10_controller)
    ld.add_action(robotiq_controller)
